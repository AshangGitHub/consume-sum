<template>
  <h1 class="mb-4 text-lg font-black">对象存储配置</h1>
  <div
  ...
  >
    <div style="width: 800px">
      ...
      >
        ...
        <el-form-item label="AppkeyId" prop="AppkeyId">
          <el-input v-model="ruleForm.mchId" />
        </el-form-item>
        <el-form-item label="AppkeySecret" prop="AppkeySecret">
          <el-input v-model="ruleForm.merchantSerialNumber" />
        </el-form-item>
        <el-form-item label="BaseURL" prop="BaseURL">
          <el-input v-model="ruleForm.transferSceneId" />
        </el-form-item>
