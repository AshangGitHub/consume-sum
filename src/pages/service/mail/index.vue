<template>
  <h1 class="mb-4 text-lg font-black">邮件配置</h1>
  <div
  ...
  >
    <div style="width: 800px">
      <el-form
        ...
        status-icon
      >
        <el-form-item label="协议服务器" prop="AccessKey">
          <el-input v-model="ruleForm.appId" />
        </el-form-item>
        <el-form-item label="端口号" prop="AccessSecret">
          <el-input v-model="ruleForm.mchId" />
        </el-form-item>
        <el-form-item label="发件人邮箱" prop="Sign">
          <el-input v-model="ruleForm.merchantSerialNumber" />
        </el-form-item>
        <el-form-item label="发件人密码" prop="privateKeyPath">
          <el-input v-model="ruleForm.privateKeyPath" type="password" />
        </el-form-item>
        <el-form-item>
